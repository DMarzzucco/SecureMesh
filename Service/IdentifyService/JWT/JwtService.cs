...
namespace IdentifyService.JWT
{
    public class JwtService : IJwtService
    {
        ...
        /// <summary>
        /// Generate Verify New Email OTT
        /// </summary>
        /// <param name="user"></param>
        /// <param name="sessionId"></param>
        /// <param name="newEmail"></param>
        /// <returns></returns>
        public async Task<string> GenerateVerifyNewEmailOTT(UserModel user, int sessionId, string newEmail)
        {
            var key = Encoding.UTF8.GetBytes(this._secretKey);
            var tokenHandler = new JwtSecurityTokenHandler();
            var tokenDescription = new SecurityTokenDescriptor
        ...
        public bool IsTokenExpirationSoon(string token)
        {
            ...
            return jwtToken.ValidTo <= DateTime.UtcNow.AddMinutes(60);
        }
        /// <summary>
        /// Validate Token
        /// </summary>
